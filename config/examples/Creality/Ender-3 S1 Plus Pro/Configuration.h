...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 S1 Plus Pro"
...
#define HEATER_0_MAXTEMP 300 // account for HOTEND_OVERSHOOT
...
#define PROBE_OFFSET_Z_MIN -5
#define PROBE_OFFSET_Z_MAX 10
